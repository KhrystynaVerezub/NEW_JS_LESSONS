...
document.write(`<tr>
                  ...
                  <td>${productCount1}</td>
                  <td>${productPrice1}</td>
                  <td>${productCount1 * productPrice1}</td>
                </tr>`)
...
document.write(`<tr>
                  ...
                  <td>${productCount2}</td>
                  <td>${productPrice2}</td>
                  <td>${productCount2 * productPrice2}</td>
                </tr>`)
...
document.write(`<tr>
                  ...
                  <td>${productCount3}</td>
                  <td>${productPrice3}</td>
                  <td>${productCount3 * productPrice3}</td>
                </tr>`)
...
document.write(`<tfoot>
                  <tr>
                    ...
                    <th>${(productCount1 * productPrice1) + (productCount2 * productPrice2) + (productCount3 * productPrice3)}</th>
                  </tr>
                </tfoot>`)
